package com.igor.bookstore.service;
...
import com.igor.bookstore.BookstoreApplication;
...
public class DBService {
	...
	public void instanciaBaseDeDados()	 {
		...
		Livro l2 = new Livro(null, "Engenharia de Sofware", "Lowis V. Gerstner", "Lorem ipsum", cat1);
		Livro l3 = new Livro(null, "The Time Machine", "H.G.Wells", "Lorem ipsum", cat2);
		Livro l4 = new Livro(null, "The War of the Worlds", "H.G.Wells", "Lorem ipsum", cat2);
		Livro l5 = new Livro(null, "Robot", "Isaac Asimov", "Lorem ipsum", cat2);
